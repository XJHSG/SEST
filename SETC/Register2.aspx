<%@ Page Title="" Language="C#" MasterPageFile="~/frontend.master" AutoEventWireup="true" CodeFile="Register2.aspx.cs" Inherits="Register2" %>
...
<div id="page2">
    ...
    <div style="margin-top:-25px;"><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="密码必填" ControlToValidate="Password"></asp:RequiredFieldValidator>
    ...
    <div style="right:auto;text-align: center;"> 
        <asp:Button ID="Button1" runat="server" Text=" 用户注册 " CssClass="Button" 
            onclick="Button1_Click" Visible="false" OnClientClick="return confirm('一旦注册,登录名无法改变,是否确定注册？');" /> <h4 Visible="false">暂不开放注册！</h4>
</div>
  <p>&nbsp;</p>   
<div style="right:auto;text-align: center;">
