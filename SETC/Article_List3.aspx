                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 mix category-photos" data-nameorder="1" data-dateorder="3" style="display: inline-block;" >
                                                <div class="media-item animate-onscroll " >
                                                    <div class="media-image">
                                                        <a href='Article_View2.aspx?ID=<%# Eval("ID") %>&c=<%# Eval("SubName") %>'>
                                                            <img src='<%# Eval("CoverImageURL") %>' /></a>
                                                    </div>
                                                    <div class="media-info">
                                                        <div class="media-header">
                                                            <div class="media-caption">
                                                                <h4 class="post-title"><a href='Article_View2.aspx?ID=<%# Eval("ID") %>&c=<%# Eval("SubName") %>'><%# Eval("Title") %></a></h4>
                                                        ...
                                                        <div class="media-button">
										                    <a href='Article_View2.aspx?ID=<%# Eval("ID") %>&c=<%# Eval("SubName") %>' class="button big button-arrow">详细</a>									
                                                        </div>
                     ...
                     <ItemTemplate>
                          <div class="Sublist2" style="clear: both; width:100%;margin-top:10px;">
                            <div id="ItemIndex" style="float: left; width: 5%; text-align: left;">
                             ...
                             <p> <a href='Article_List4.aspx?ID=<%# Eval("SubID") %>' >【<%# Eval("SubName") %>】 </a>----<a href='Article_View2.aspx?ID=<%# Eval("ID") %>'><%# Eval("Title") %></a></p>
                               </div>
