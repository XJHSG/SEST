$(document).ready(function(){
	...
	function enableStickyHeader(){
		...
		function animateHeader(){
			...
			//        $body.css('padding-top', 230 + 'px');
			//    }
			//    else {
			//        $('#header.sticky-header').removeClass('animate-header');
			//        $body.css('padding-top', 200 + 'px');
			//    }
	...
	function enableAccordions(){
		...
		$('.accordions').each(function(){
		    ...
		    // Set First Accordion2 As Active
			$(this).find('.accordion-content2').hide();
			if (!$(this).hasClass('toggles')) {
			    //$(this).find('.accordion:first-child').addClass('accordion-active2');
			    $(this).find('.accordion:first-child .accordion-content2').show();
			}

		    // Set Accordion2 Events
			$(this).find('.accordion-header2').click(function () {

			    if (!$(this).parent().hasClass('accordion-active2')) {

			        // Close other accordions
			        if (!$(this).parent().parent().hasClass('toggles')) {
			            $(this).parent().parent().find('.accordion-active2').removeClass('accordion-active2').find('.accordion-content2').slideUp(300);
			        }

			        // Open Accordion
			        $(this).parent().addClass('accordion-active2');
			        $(this).parent().find('.accordion-content2').slideDown(300);

			    } else {

			        // Close Accordion
			        $(this).parent().removeClass('accordion-active2');
			        $(this).parent().find('.accordion-content2').slideUp(300);
