...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="CurrentPosition">
        当前位置：<a href="Article_Add.aspx">文章模块</a> >> <a href="Article_draft.aspx">草稿箱</a> >><a href="#">删除草稿</a>
    </div>
                                    ...
                                    <div id="RightContent">
                                        <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="False" HeaderStyle-Height="24px" class="table table-striped table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Comment" HeaderText="留言内容" ItemStyle-Width="350" ></asp:BoundField>
                                                <asp:BoundField DataField="PublisherName" HeaderText="留言者" ItemStyle-Width="60" />
                                                <asp:BoundField DataField="PublishTime" HeaderText="时间" ItemStyle-Width="60" />
                                                <asp:BoundField DataField="Visible" HeaderText="可见" ItemStyle-Width="60" />
                                            </Columns>
                                        </asp:GridView>
                                        <br />
                                    </div>
