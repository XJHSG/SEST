                            ...
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="False" HeaderStyle-Height="24px" class="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ωπµ„Õº" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <img src='<%# Eval("PhotoSrc") %>' alt='<%# Eval("LinkURL") %>' width="400" height="150" />
                                        </ItemTemplate>

                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Àı¬‘Õº" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <img src='<%# Eval("Thumbnail") %>' alt='<%# Eval("LinkURL") %>' width="300" height="150" />
                                        </ItemTemplate>
