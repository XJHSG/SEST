        ...
        <div class="col-lg-6 col-sm-6 col-xs-12">
            <div class="well with-header  with-footer">
                ...
                <asp:Panel ID="QeustionPanel" runat="server">
                  ...
                  <asp:UpdatePanel ID="CatUpdatePanel" runat="server">
                     <ContentTemplate>
                          <span class="text-primary">文章栏目权限设置</span>
                         <p></p>
                              <asp:Panel ID="CatPanel" runat="server">
                                   <span class="text-muted">一级分类：</span>
                       <asp:DropDownList ID="Cats" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Cats_SelectedIndexChanged">
                          ...
                          <asp:Panel ID="SubPanel" runat="server" >
                              <span class="text-muted">二级分类：</span>
                              <asp:CheckBoxList ID="SubCheckBoxList" runat="server" Style="margin-left: 5px; margin-top: 0px; text-align: left; width: 100%"  RepeatDirection="Horizontal"
                ...
                <asp:Button ID="SetCatOk" class="btn btn-info" runat="server" Text="保存设置" OnClick="SetCatOk_Click" />
              </asp:PlaceHolder>
